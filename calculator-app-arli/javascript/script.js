//buat fungsi oppendToDisplay()
function oppendToDisplay(value) {
...
//buat fungsi calculatorResult()/ perhitungan
function calculateResult() {
    try {

        let expression = document.getElementById('display').value
        .replace(/\^/g, '**') // ubah * jadi ** untuk pangkat
    ...
    function powerN (){
        let display = document.getElementById('display');
        display.value += '^'; //menambahkan simbol ^ agar bisa dijadikan pangkat 
    } 
